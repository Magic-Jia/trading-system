...
- Promoted: MEMORY.md
- See Also: repeated failure to convert runtime exit events into user-facing status updates on the same day; resolved by changing orchestration default from exec background to sessions_spawn/ACP for long-running user-facing development
