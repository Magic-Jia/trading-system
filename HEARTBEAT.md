...
- That fallback status update must say explicitly: whether Codex is currently running, whether there is a new commit, the latest verified command/result, the current blocker (if any), and the next action.
